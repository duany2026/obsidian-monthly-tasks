...
var MonthlyView = class extends import_obsidian2.ItemView {
  ...
  renderMultiDayTaskBars(multiDayTasks, calendarDays) {
    ...
    for (const span of taskSpans) {
      ...
      if (span.task.completed && this.plugin.settings.completedTaskStyle === "strike")
  ...
  renderDayCell(day, tasks) {
    ...
    const displayTasksList = this.plugin.settings.completedTaskStyle === "hide" ? tasks.filter((t) => !t.completed) : tasks;
  ...
  display() {
    ...
    new import_obsidian3.Setting(containerEl).setName("\u5237\u65B0\u8282\u5047\u65E5\u6570\u636E").setDesc("\u4ECE\u7F51\u7EDC\u91CD\u65B0\u83B7\u53D6\u5F53\u5E74\u8282\u5047\u65E5\u4FE1\u606F").addButton((button) => button.setButtonText("\u5237\u65B0").onClick(async () => {
      ...
      try {
        ...
        this.plugin.refreshView();
        new import_obsidian3.Notice("\u8282\u5047\u65E5\u6570\u636E\u5DF2\u5237\u65B0");
      } catch (e) {
        new import_obsidian3.Notice("\u5237\u65B0\u5931\u8D25: " + e.message);
      }
